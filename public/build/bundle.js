...
var app = (function () {
    ...
    /* src/AudioPlayer.svelte generated by Svelte v3.37.0 */
    const file$1 = "src/AudioPlayer.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(track, file$1, 37, 8, 534);
    			if (audio.src !== (audio_src_value = /*src*/ ctx[0])) attr_dev(audio, "src", audio_src_value);
    			audio.controls = true;
    			attr_dev(audio, "class", "svelte-1os0yzi");
    			add_location(audio, file$1, 33, 4, 460);
    			add_location(div, file$1, 32, 0, 450);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, players, stopAll, player, src });
    ...
    // (48:0) {#each [carouselPhotos[index]] as src (index)}
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1bw0rir");
    			add_location(img, file, 48, 1, 966);
    			this.first = img;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*index*/ 1 && img.src !== (img_src_value = /*src*/ ctx[4])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:0) {#each [carouselPhotos[index]] as src (index)}",
    		ctx
    	});
    ...
    // (53:0) {#each [audioTracks[index]] as src (index)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*index*/ 1) audioplayer_changes.src = /*src*/ ctx[4];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(53:0) {#each [audioTracks[index]] as src (index)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value_1 = [/*carouselPhotos*/ ctx[1][/*index*/ ctx[0]]];
    	...
    	let each_value = [/*audioTracks*/ ctx[2][/*index*/ ctx[0]]];
    	validate_each_argument(each_value);
    	const get_key_1 = ctx => /*index*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "next-btn svelte-1bw0rir");
    			add_location(button0, file, 50, 0, 1012);
    			attr_dev(button1, "class", "generate-btn svelte-1bw0rir");
    			add_location(button1, file, 56, 0, 1145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*carouselPhotos, index*/ 3) {
    				each_value_1 = [/*carouselPhotos*/ ctx[1][/*index*/ ctx[0]]];
    				validate_each_argument(each_value_1);
    				group_outros();
    				validate_each_keys(ctx, each_value_1, get_each_context_1, get_key);
    				each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx, each_value_1, each0_lookup, t0.parentNode, outro_and_destroy_block, create_each_block_1, t0, get_each_context_1);
    				check_outros();
    			}

    			if (dirty & /*audioTracks, index*/ 5) {
    				each_value = [/*audioTracks*/ ctx[2][/*index*/ ctx[0]]];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key_1);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key_1, 1, ctx, each_value, each1_lookup, t3.parentNode, outro_and_destroy_block, create_each_block, t3, get_each_context);
    				check_outros();
    			}
    		},
    		i: function intro(local) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("audioTracks" in $$props) $$invalidate(2, audioTracks = $$props.audioTracks);
    	...
    	return [index, carouselPhotos, audioTracks, next];
    }
